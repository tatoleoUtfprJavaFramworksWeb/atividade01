package com.fomularios.application.views;
 ...
 */
@PWA(name = "Fomularios", shortName = "Fomularios", enableInstallPrompt = false)
@Theme(themeFolder = "fomularios")
@PageTitle("Main")
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "Fomularios logo"));
        logoLayout.add(new H1("Fomularios"));
